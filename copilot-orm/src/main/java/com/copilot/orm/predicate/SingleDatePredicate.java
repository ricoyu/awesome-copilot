...
import static com.copilot.orm.predicate.DateMatchMode.EARLIER_THAN_OR_SAME;
import static com.copilot.orm.predicate.DateMatchMode.EXACT;
import static com.copilot.orm.predicate.DateMatchMode.LATER_THAN;
import static com.copilot.orm.predicate.DateMatchMode.LATER_THAN_OR_SAME;
...
public class SingleDatePredicate extends AbstractDatePredicate {
	...
	public SingleDatePredicate(String propertyName, Date specifiedDate) {
		...
		addCandidateMatchMode(DateMatchMode.EARLIER_THAN , EARLIER_THAN_OR_SAME, EXACT, LATER_THAN, LATER_THAN_OR_SAME);
	}
