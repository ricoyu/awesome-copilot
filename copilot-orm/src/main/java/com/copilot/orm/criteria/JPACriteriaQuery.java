...
public class JPACriteriaQuery<T> implements Serializable {
	...
	public JPACriteriaQuery<T> addPredicate(com.copilot.orm.predicate.Predicate predicate) {
		this.predicates.add(predicate.toPredicate(criteriaBuilder, root));
		return this;
	}

	public JPACriteriaQuery<T> addPredicates(com.copilot.orm.predicate.Predicate... predicates) {
	...
	public JPACriteriaQuery<T> addPredicates(List<com.copilot.orm.predicate.Predicate> predicates) {
		if (predicates != null && predicates.size() > 0) {
			for (com.copilot.orm.predicate.Predicate predicate : predicates) {
