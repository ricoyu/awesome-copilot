 ...
 * @on
 */
public class IfEqual extends Directive {
	...
	public boolean render(InternalContextAdapter context, Writer writer,
		...
		Object compareValue = node.jjtGetChild(1).value(context);
		String outputSQL1 = (String)node.jjtGetChild(2).value(context);
		String outputSQL2 = (String)node.jjtGetChild(3).value(context);

		if (paramValue != null && paramValue.equals(compareValue)) {
			writer.append(outputSQL1);
		} else {
			writer.append(outputSQL2);
		}
		return true;
	}
