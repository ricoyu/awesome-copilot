...
public final class MappingSupport {
	...
	public static ElasticPutMappingBuilder extractIndexMapping(Class entity) {
		...
		//获取字段级别的Mapping设置
		Set<Field> fields = ReflectionUtils.filterFieldByAnnotation(entity, com.copilot.search.annotation.Field.class);
		for (Field field : fields) {
			com.copilot.search.annotation.Field annotation = field.getAnnotation(com.copilot.search.annotation.Field.class);
			//ES 中的字段名
