 ...
 * @version 1.0
 */
public abstract class SubHistogramAgg {
	...
	public SubHistogramAgg interval(double interval) {
	 ...
	 * @return
	 */
	public SubHistogramAgg minDocCount(Integer minDocCount) {
	 ...
	 */
	public SubHistogramAgg extendedBounds(Long minBound, Long maxBound) {
