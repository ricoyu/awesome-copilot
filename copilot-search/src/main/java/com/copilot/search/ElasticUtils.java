...
import com.copilot.common.lang.context.ThreadContext;
...
import com.copilot.search.builder.ElasticContextSuggestBuilder;
import com.copilot.search.builder.ElasticMultiGetBuilder;
import com.copilot.search.builder.ElasticQueryBuilder;
import com.copilot.search.builder.ElasticSuggestBuilder;
import com.copilot.search.builder.ElasticUpdateBuilder;
import com.copilot.search.builder.admin.ClusterSettingBuilder;
import com.copilot.search.builder.admin.ElasticIndexBuilder;
import com.copilot.search.builder.admin.ElasticIndexTemplateBuilder;
import com.copilot.search.builder.admin.ElasticPutMappingBuilder;
import com.copilot.search.builder.admin.ElasticReindexBuilder;
import com.copilot.search.builder.admin.ElasticSettingsBuilder;
import com.copilot.search.builder.admin.ElasticUpdateSettingBuilder;
import com.copilot.search.builder.agg.ElasticAvgAggregationBuilder;
import com.copilot.search.builder.agg.ElasticCardinalityAggregationBuilder;
import com.copilot.search.builder.agg.ElasticCompositeAggregationBuilder;
import com.copilot.search.builder.agg.ElasticDateHistogramAggregationBuilder;
import com.copilot.search.builder.agg.ElasticHistogramAggregationBuilder;
import com.copilot.search.builder.agg.ElasticMaxAggregationBuilder;
import com.copilot.search.builder.agg.ElasticMinAggregationBuilder;
import com.copilot.search.builder.agg.ElasticMultiTermsAggregationBuilder;
import com.copilot.search.builder.agg.ElasticRangeAggregationBuilder;
import com.copilot.search.builder.agg.ElasticStatsAggregationBuilder;
import com.copilot.search.builder.agg.ElasticSumAggregationBuilder;
import com.copilot.search.builder.agg.ElasticTermsAggregationBuilder;
import com.copilot.search.builder.bulk.ESBulkProcessor;
import com.copilot.search.builder.query.ElasticBoolQueryBuilder;
import com.copilot.search.builder.query.ElasticExistsQueryBuilder;
import com.copilot.search.builder.query.ElasticIdsQueryBuilder;
import com.copilot.search.builder.query.ElasticMatchAllQueryBuilder;
import com.copilot.search.builder.query.ElasticMatchPhraseQueryBuilder;
import com.copilot.search.builder.query.ElasticMatchQueryBuilder;
import com.copilot.search.builder.query.ElasticMultiMatchQueryBuilder;
import com.copilot.search.builder.query.ElasticPipelineBuilder;
import com.copilot.search.builder.query.ElasticQueryStringBuilder;
import com.copilot.search.builder.query.ElasticScrollQueryBuilder;
import com.copilot.search.builder.query.ElasticTemplateQueryBuilder;
import com.copilot.search.builder.query.ElasticTermQueryBuilder;
import com.copilot.search.builder.query.ElasticTermsQueryBuilder;
import com.copilot.search.builder.query.ElasticUriQueryBuilder;
import com.copilot.search.cache.ElasticCacheUtils;
import com.copilot.search.constants.ElasticConstants;
import com.copilot.search.enums.Analyzer;
import com.copilot.search.enums.Dynamic;
import com.copilot.search.enums.IndexState;
import com.copilot.search.exception.IndexTemplateCreateException;
import com.copilot.search.factory.TransportClientFactory;
import com.copilot.search.support.BulkResult;
import com.copilot.search.support.IndexSupport;
import com.copilot.search.support.MappingSupport;
import com.copilot.search.support.RestSupport;
import com.copilot.search.support.SettingsSupport;
import com.copilot.search.support.UpdateResult;
import com.copilot.search.vo.Index;
import com.copilot.search.vo.VersionedDoc;
...
import static com.copilot.common.lang.utils.Assert.notNull;
