...
import com.copilot.search.builder.agg.support.RangeAggResult;
import com.copilot.search.builder.query.ElasticTermQueryBuilder;
import com.copilot.search.support.StatsAggResult;
...
public class AggTest {
	...
	public void testAggAfterQuery() {
		...
		QueryBuilder queryBuilder = ReflectionUtils.invokeMethod("builder", elasticTermQueryBuilder);
