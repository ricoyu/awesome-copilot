...
import com.copilot.search.ElasticUtils.Admin;
import com.copilot.search.ElasticUtils.Cluster;
import com.copilot.search.annotation.DocId;
import com.copilot.search.builder.admin.AbstractMappingBuilder;
import com.copilot.search.builder.admin.ElasticIndexMappingBuilder;
...
import com.copilot.search.enums.ContextType;
import com.copilot.search.enums.Direction;
import com.copilot.search.enums.Dynamic;
import com.copilot.search.enums.FieldType;
import com.copilot.search.enums.cluster.AllocationEnable;
import com.copilot.search.pojo.Movie;
import com.copilot.search.support.BulkResult;
import com.copilot.search.support.FieldDef;
...
import static com.copilot.json.jackson.JacksonUtils.toPrettyJson;
import static com.copilot.search.enums.FieldType.COMPLETION;
import static com.copilot.search.enums.FieldType.KEYWORD;
import static com.copilot.search.enums.FieldType.TEXT;
...
public class ElasticUtilsTest {
	...
	public void testStructuredQuery() {
		...
		List<Object> products = ElasticUtils.constantScoreQuery("products")
				...
				.type(com.copilot.search.pojo.Product.class)
				.queryForList();
	...
	public void testStructuredQuery2() {
		List<com.copilot.search.pojo.Product> products = ElasticUtils.constantScoreQuery("products")
				.queryBuilder(termQuery("avaliable", true))
				.type(com.copilot.search.pojo.Product.class)
				.queryForList();
		products.stream()
				.map(com.copilot.search.pojo.Product::isAvaliable)
				.forEach(System.out::println);
	}
