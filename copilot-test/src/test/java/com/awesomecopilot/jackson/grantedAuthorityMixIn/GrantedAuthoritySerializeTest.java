...
import com.awesomecopilot.jackson.grantedAuthorityMixIn.mixin.GrantedAuthorityMixIn;
import com.awesomecopilot.jackson.grantedAuthorityMixIn.mixin.SimpleGrantedAuthorityMixIn;
...
public class GrantedAuthoritySerializeTest {
	...
	public static void main(String[] args) {
		...
		//String json = "{\"userId\":\"1\",\"username\":\"ricoyu\",\"password\":\"123456\",\"nickname\":\"三少爷\",\"authorities\":[{\"@class\":\"com.awesomecopilot.jackson.grantedAuthorityMixIn.SimpleGrantedAuthority\",\"authority\":\"ADMIN\"},{\"@class\":\"com.awesomecopilot.jackson.grantedAuthorityMixIn.SimpleGrantedAuthority\",\"authority\":\"USER\"}],\"permissions\":[\"resource2\",\"resource1\"],\"accountNonExpired\":true,\"accountNonLocked\":true,\"credentialsNonExpired\":true,\"enabled\":true}";
