package com.awesomecopilot.java8.stream.async;

import com.awesomecopilot.java8.stream.async.model.Client;
import com.awesomecopilot.java8.stream.async.service.ServiceInvoker;
