package com.awesomecopilot.concurrent.aqs;
 ...
 * @version 1.0
 */
public abstract class CopilotAbstractQueuedSynchronizer extends CopilotAbstractOwnableSynchronizer implements Serializable {
	 ...
	 */
	protected CopilotAbstractQueuedSynchronizer() {
	}
	...
	public class ConditionObject implements Condition, Serializable {
		 ...
		 * @return {@code true} if owned
		 */
		final boolean isOwnedBy(CopilotAbstractQueuedSynchronizer sync) {
			return sync == CopilotAbstractQueuedSynchronizer.this;
		}
		
		/**
		 * Queries whether any threads are waiting on this condition.
		 * Implements {@link CopilotAbstractQueuedSynchronizer#hasWaiters(ConditionObject)}.
		 *
		 * @return {@code true} if there are any waiting threads
		 ...
		 * this condition.
		 * Implements {@link CopilotAbstractQueuedSynchronizer#getWaitQueueLength(ConditionObject)}.
		 *
	 ...
	 */
	//private static final CopilotUnsafe unsafe = CopilotUnsafe.getUnsafe();
	...
	static {
		try {
			...
			//		(CopilotAbstractQueuedSynchronizer.class.getDeclaredField("state"));
			//headOffset = unsafe.objectFieldOffset
			//		(CopilotAbstractQueuedSynchronizer.class.getDeclaredField("head"));
			//tailOffset = unsafe.objectFieldOffset
			//		(CopilotAbstractQueuedSynchronizer.class.getDeclaredField("tail"));
