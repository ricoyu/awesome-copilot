...
public class ZookeeperClientTest {
	...
	public void testCreateEphemeral() {
		String value = zookeeperClient.createEphemeral("/com/copilot");
	...
	public void testCreatePersistent() {
		String value = zookeeperClient.createPersistent("/com/copilot");
		System.out.println(value);
	}
	
	@Test
	public void testCreatePersistentWithValue() {
		String value = zookeeperClient.createPersistent("/com/copilot", "handsome");
		System.out.println(value);
	}
