package com.awesomecopilot.zookeeper.selectmaster.dynamic;
...
public class MyServer1 {
	...
	public static void main(String[] args) {
		...
		myServer1.startZK("192.168.102.104:2181,192.168.102.106:2181,192.168.102.107:2181", 20000);

		// 功能处理
		myServer1.createNode(PARENT_NODE + "/currentMaster", "server1", CreateMode.EPHEMERAL_SEQUENTIAL);
