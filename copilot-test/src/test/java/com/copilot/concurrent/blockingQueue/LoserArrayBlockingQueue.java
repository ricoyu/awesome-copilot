 ...
 */
public class LoserArrayBlockingQueue<E> extends AbstractQueue<E> implements BlockingQueue<E>, java.io.Serializable {
     ...
     */
    public LoserArrayBlockingQueue(int capacity) {
        this(capacity, false);
    }
     ...
     * @throws IllegalArgumentException if {@code capacity < 1}
     */
    public LoserArrayBlockingQueue(int capacity, boolean fair) {
        if (capacity <= 0)
    ...
    private class Itr implements Iterator<E> {
        ...
        Itr() {
            ...
            lastRet = NONE;
            final ReentrantLock lock = LoserArrayBlockingQueue.this.lock;
            lock.lock();
            try {
                if (count == 0) {
                    // assert itrs == null;
                    ...
                    final int takeIndex = LoserArrayBlockingQueue.this.takeIndex;
