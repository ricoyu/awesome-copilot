...
public final class MappingSupport {
	...
	public static ElasticPutMappingBuilder extractIndexMapping(Class entity) {
		...
		//获取字段级别的Mapping设置
		Set<Field> fields = ReflectionUtils.filterFieldByAnnotation(entity, com.awesomecopilot.search8x.annotation.Field.class);
		for (Field field : fields) {
			com.awesomecopilot.search8x.annotation.Field
					annotation = field.getAnnotation(com.awesomecopilot.search8x.annotation.Field.class);
			//ES 中的字段名
