...
public class ElasticDateHistogramSubAggregation extends SubAggregation implements AvgSubAggregatable, TopHitsSubAggregatable {
	 ...
	 * @return ElasticDateHistogramSubAggregation
	 */
	public ElasticDateHistogramSubAggregation calendarInterval(com.awesomecopilot.search8x.enums.CalendarInterval interval) {
		notNull(interval, "interval cannot be null!");
		switch (interval) {
			case MINUTE:
				this.calendarInterval = CalendarInterval.Minute;
				break;
			case HOUR:
				this.calendarInterval = CalendarInterval.Hour;
				break;
			case DAY:
				this.calendarInterval = CalendarInterval.Day;
				break;
			case WEEK:
				this.calendarInterval = CalendarInterval.Week;
				break;
			case MONTH:
				this.calendarInterval = CalendarInterval.Month;
				break;
			case QUARTER:
				this.calendarInterval = CalendarInterval.Quarter;
				break;
			case YEAR:
				this.calendarInterval = CalendarInterval.Year;
				break;
		}
		return this;
	}
