...
public class MatchQueryTest {
	...
	public void testPainless() {
		...
		ssb.scriptField("my_field", new Script("doc['email'].value"));
		log.debug("Query DSL:\n{}", new JSONObject(ssb.toString()).toString(2));
		SearchResponse resp = SearchRequestSupport.search(ElasticUtils.QUERY_CLIENT,
				new String[] {"kibana_sample_data_ecommerce"}, ssb);
