...
public class ElasticUtilsIndexTest {
	...
	public void testBulkUpdate() {
		RestHighLevelClient client = ElasticUtils.CLIENT;
		...
		bulkRequest.add(new UpdateRequest("test-single-perf", "qNgT6XwBRSj7f1nTb7Cq").doc(doc));
		bulkRequest.add(new UpdateRequest("test-single-perf", "qdgT6XwBRSj7f1nTb7Cv").doc("my_name", "三少爷"));
		bulkRequest.add(new UpdateRequest("test-bulk-perf", "ONcT6XwBRSj7f1nTCuzQ").doc(doc));
		bulkRequest.add(new UpdateRequest("test-bulk-perf", "PNcT6XwBRSj7f1nTCuzQ").doc(doc));
		try {
