...
public class AggTest {
	...
	public void testAggAfterQuery() {
		...
		SearchResponse searchResponse = com.awesomecopilot.search8x.support.SearchRequestSupport.search(
				ElasticUtils.CLIENT, "employees",
				ssb -> ssb.query(queryBuilder).aggregation(AggregationBuilders.stats("stats_agg").field("salary")));
	...
	public void testFilterAggregation() {
		...
		SearchResponse searchResponse = com.awesomecopilot.search8x.support.SearchRequestSupport.search(
				ElasticUtils.CLIENT, "employees", ssb -> ssb.aggregation(aggregationBuilder));
